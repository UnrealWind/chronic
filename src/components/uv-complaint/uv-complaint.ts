 ...
 */
@Component({
  selector: 'uv-complaint',
  templateUrl: 'uv-complaint.html'
})
export class UvComplaintComponent {
  @Input() xlData
  ...
  getData() {
    ...
    url = `${this.Constant.BackstageUrl_unitView}/unite/resource/single/24?filter__xlPatientId=${xlPatientId}&filter__xlMedicalId=${xlMedicalId}`
